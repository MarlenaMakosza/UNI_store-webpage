...
export const metadata = {
  title: 'Regulamin - TechNest',
  description: 'Regulamin sklepu TechNest',
};
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          <div className="bg-gray-900 rounded-xl p-8 md:p-12 border border-gray-800">
            <div className="prose prose-invert max-w-none">
              ...
              <h2 className="text-2xl font-bold text-white mt-8 mb-4">§2. Zasady korzystania ze sklepu</h2>
              <p className="text-gray-300 mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mt-8 mb-4">§3. Składanie zamówień</h2>
              <p className="text-gray-300 mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mt-8 mb-4">§4. Płatności i dostawa</h2>
              <p className="text-gray-300 mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mt-8 mb-4">§5. Reklamacje</h2>
              <p className="text-gray-300 mb-6">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce finibus risus massa, posuere feugiat diam commodo in. Integer pharetra egestas lorem. Duis consequat finibus quam. Nam felis odio, pellentesque ac eros quis, finibus lacinia est. Nulla consectetur dui in tempus iaculis. Phasellus viverra metus sit amet fermentum bibendum.
              </p>

              <h2 className="text-2xl font-bold text-white mt-8 mb-4">§6. Prawo odstąpienia od umowy</h2>
              <p className="text-gray-300 mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mt-8 mb-4">§7. Postanowienia końcowe</h2>
