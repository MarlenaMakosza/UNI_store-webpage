...
export interface ApiContactMessageContactMessage
  ...
  attributes: {
    ...
    sendCopy: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    subject: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 255;
...
export interface ApiCustomerCustomer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    addresses: Schema.Attribute.Component<'order.address', true>;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currency: Schema.Attribute.String & Schema.Attribute.DefaultTo<'PLN'>;
...
export interface ApiPaymentMethodPaymentMethod
  ...
  info: {
    description: 'Payment methods available for orders (Przelewy24, PayU, Cash on Delivery, etc.)';
  ...
  attributes: {
    ...
    feeType: Schema.Attribute.Enumeration<['fixed', 'percentage']> &
    ...
    merchantId: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    provider: Schema.Attribute.Enumeration<
      ['przelewy24', 'payu', 'cash_on_delivery', 'bank_transfer']
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    supportInstallments: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProductCategoryProductCategory
  ...
  info: {
    description: 'Hierarchical product categories for e-commerce';
...
export interface ApiProductTagProductTag extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Tags for product categorization and filtering';
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'E-commerce product for electronics store';
    displayName: 'Product';
    pluralName: 'products';
  ...
  attributes: {
    ...
    tags: Schema.Attribute.Relation<
      ...
      'api::product-tag.product-tag'
    >;
    taxRate: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<23>;
    technicalDescription: Schema.Attribute.JSON;
    technicalSpecs: Schema.Attribute.Component<'product.technical-specs', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    warranty: Schema.Attribute.Integer;
    warrantyUnit: Schema.Attribute.Enumeration<['months', 'years']>;
...
export interface ApiShippingMethodShippingMethod
  ...
  info: {
    description: 'Shipping methods available for orders (InPost, DPD, UPS, etc.)';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    maxDimensions: Schema.Attribute.JSON;
    maxEstimatedDays: Schema.Attribute.Integer;
    maxWeight: Schema.Attribute.Decimal;
    minEstimatedDays: Schema.Attribute.Integer;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    provider: Schema.Attribute.Enumeration<
      ['inpost', 'dpd', 'ups', 'dhl', 'poczta_polska', 'courier', 'pickup']
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    requiresAddress: Schema.Attribute.Boolean &
