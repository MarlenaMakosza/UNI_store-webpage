              ...
              {categories.map((category) => {
                ...
                return (
                  <a
                    ...
                    class="bg-gray-900 rounded-xl overflow-hidden border border-gray-800 card-hover block group"
                  >
                    <div class="h-48 bg-gradient-to-br from-neon-violet/20 to-electric-blue/20 flex items-center justify-center">
                    ...
                    <div class="p-6">
                      ...
                      <div class="flex items-center justify-between">
                        <span class="text-neon-violet font-semibold">{categoryProducts.length} produktow</span>
                        <svg class="w-5 h-5 text-gray-400 group-hover:text-neon-violet group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
