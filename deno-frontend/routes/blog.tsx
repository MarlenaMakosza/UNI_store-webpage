          ...
          <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {articles.map((article) => (
                <article
                  key={article.id}
                  class="bg-gray-900 rounded-xl overflow-hidden border border-gray-800 card-hover"
                >
                  {/* Featured Image */}
                  <div class="h-48 bg-gradient-to-br from-neon-violet/20 to-electric-blue/20 flex items-center justify-center text-6xl">
                  ...
                  <div class="p-6">
                    ...
                    <div class="flex items-center justify-between mb-3">
                      <span class="text-xs font-semibold text-neon-violet uppercase tracking-wider">
                        {article.category}
                      </span>
                    ...
                    <a
                      ...
                      class="inline-flex items-center text-neon-violet hover:text-electric-blue font-semibold transition-colors"
                    >
                      Czytaj wiecej
