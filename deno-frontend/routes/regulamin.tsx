          ...
          <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div class="prose prose-lg max-w-none">
              <div class="bg-white rounded-lg p-8 border border-gray-200 mb-8 shadow-sm">
                <h2 class="text-2xl font-bold text-gray-800 mb-4">§1. Postanowienia ogolne</h2>
              ...
              <div class="bg-white rounded-lg p-8 border border-gray-200 mb-8 shadow-sm">
                ...
                <ul class="space-y-3 text-gray-600">
                  <li><strong class="text-gray-800">Sklep</strong> - sklep internetowy dostepny pod adresem technest.pl</li>
                  <li><strong class="text-gray-800">Sprzedawca</strong> - TechNest Sp. z o.o.</li>
                  <li><strong class="text-gray-800">Klient</strong> - osoba fizyczna, prawna lub jednostka organizacyjna skladajaca zamowienie</li>
                  <li><strong class="text-gray-800">Produkt</strong> - towar dostepny w ofercie sklepu</li>
                  <li><strong class="text-gray-800">Zamowienie</strong> - oswiadczenie woli Klienta zmierzajace do zawarcia umowy sprzedazy</li>
                </ul>
              </div>

              <div class="bg-white rounded-lg p-8 border border-gray-200 mb-8 shadow-sm">
                <h2 class="text-2xl font-bold text-gray-800 mb-4">§3. Skladanie zamowien</h2>
                <ol class="list-decimal list-inside space-y-3 text-gray-600">
              ...
              <div class="bg-white rounded-lg p-8 border border-gray-200 mb-8 shadow-sm">
                <h2 class="text-2xl font-bold text-gray-800 mb-4">§4. Platnosci</h2>
                <ol class="list-decimal list-inside space-y-3 text-gray-600">
              ...
              <div class="bg-white rounded-lg p-8 border border-gray-200 mb-8 shadow-sm">
                <h2 class="text-2xl font-bold text-gray-800 mb-4">§6. Prawo do odstapienia od umowy</h2>
                <ol class="list-decimal list-inside space-y-3 text-gray-600">
              ...
              <div class="bg-white rounded-lg p-8 border border-gray-200 shadow-sm">
                <h2 class="text-2xl font-bold text-gray-800 mb-4">§8. Postanowienia koncowe</h2>
                <ol class="list-decimal list-inside space-y-3 text-gray-600">
